...
#define ELOCK_CHECK_BLOCK           28  //电子锁签名数据块
#define ELOCK_KEY_BLOCK             29  //电子锁钥数据块
#define ELOCK_ARGS_BLOCK            30  //电子锁参数数据块
#define ELOCK_CTRL_BLOCK            31  //电子锁控制数据块  

#define MONEY_BAG_ENABLE			32	//电子钱包启用标记数据块
#define MONEY_BAG_VALUE				33	//电子钱包值数据块
#define MONEY_BAG_BF				34	//电子钱包备份数据块 
#define MONEY_BAG_CTRL_BLOCK		35	//电子钱控制数据块 
